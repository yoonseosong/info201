...
<p>**Bar Chart**: Demographics of Nevada</p>
...
This bar chart shows the race demographics of the state that has the lowest medics to total population ratio, which was found to be Nevada. This chart was intended to show the relationship between the number of healthcare workers and race demographics in a state. This chart reveals that the state with the lowest medics to total population ratio has a sizeable minority population.
